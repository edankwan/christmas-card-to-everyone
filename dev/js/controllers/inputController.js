define([
        ...
        'mout/array/contains',
        'mout/array/forEach'
    ], function(exports, signals, contains, forEach){
        ...
        exports.onDowned = new signals.Signal();
        exports.onMoved = new signals.Signal();
        exports.onUped = new signals.Signal();

        exports.onSwipeH = new signals.Signal();
        exports.onSwipeV = new signals.Signal();
